...
* s3 path
  ...
  * template: s3://beta.elasticmapreduce/bootstrap-actions/tajo/tajo-0.10.0/template
...
Usage: install-tajo.sh [-t|--tar] [-c|--conf] [-l|--lib] [-h|--help] [-e|--env] [-s|--site] [-T|--test-home] [-H|--test-hadoop-home]
    ...
    -c, --conf [S3_PATH_TO_TAJO_CONF_DIR] 
       ...
       Ex: --conf s3://beta.elasticmapreduce/bootstrap-actions/tajo/tajo-0.10.0/template/c3.xlarge/conf
